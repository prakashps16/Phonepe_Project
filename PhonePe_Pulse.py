...
icon = Image.open(r"D:\Users\sekar\OneDrive\Desktop\Prakash\Project\phonepe_project_sam\phonepe.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Prakash",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Prakash*!
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'D:\Users\sekar\OneDrive\Desktop\Prakash\Project\phonepe\pulse\data\Statenames.csv')
            df1.State = df2
        ...
        with col2:
            ...
            df1 = pd.DataFrame(mycursor.fetchall(),columns= ['State', 'Total_Transactions', 'Total_amount'])
            df2 = pd.read_csv(r'D:\Users\sekar\OneDrive\Desktop\Prakash\Project\phonepe\pulse\data\Statenames.csv')
            df1.Total_Transactions = df1.Total_Transactions.astype('double')
            df1.State = df2
